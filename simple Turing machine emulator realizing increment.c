/**
* Данная программа эмулирует работу машины Тьюринга, которая реализует инкремент:
* число на ленте увеличивается на 1
*
* Двумерный массив com является таблицей для МТ, в которой описано только одно состояние (state = 1)
* 
